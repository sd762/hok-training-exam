      ...
      {canReport && (
        <Section title="分析報表">
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              <strong>考測結果分析</strong>：「不及格」拆成「測驗未達標」（分數沒到及格線）跟「考試紀律違規」（監考機制自動中止，例如人臉消失3次或切換視窗2次），兩種原因分開顯示，不再只看到籠統的「不及格」。
            </li>
            <li>
              <strong>應考次數分析</strong>（新分頁）：看大家考了幾次才有結果的分布（1次/2次/3次/4次以上），依最終結果上色。比只看「平均嘗試次數」一個數字更清楚——例如能看出是「大部分人1次就過」還是「有一群人一直卡在補考」。
            </li>
            <li>圖表形式：學員分析、國籍與年齡分布這類「組成佔比」的圖表，選定單一機構時會看到甜甜圈圖；考測結果分析/應考次數分析因為分類較多（6種結果狀態），一律用柱狀圖，不用甜甜圈圖。</li>
